...
var app = (function () {
    ...
    const file$5 = "src/components/Background.svelte";
    ...
    class Background extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { numImages: 1, randomizeBackground: 2 });
    		...
    		if (/*numImages*/ ctx[1] === undefined && !('numImages' in props)) {
    			console.warn("<Background> was created without expected prop 'numImages'");
    		}
    	}
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-tcyk2a");
    			add_location(a, file$4, 6, 4, 87);
    			attr_dev(span, "class", "link svelte-tcyk2a");
    			add_location(span, file$4, 5, 0, 63);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Link extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { link: 0, text: 1 });
    ...
    const file$3 = "src/components/LinkContainer.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "header svelte-o49g9h");
    			add_location(h2, file$3, 5, 4, 91);
    			attr_dev(div0, "class", "links-group svelte-o49g9h");
    			add_location(div0, file$3, 7, 4, 127);
    			attr_dev(div1, "class", "links-container svelte-o49g9h");
    			add_location(div1, file$3, 4, 0, 57);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "kangaroo");
    			attr_dev(img, "class", "svelte-17hd1zf");
    			add_location(img, file$2, 6, 0, 88);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(img, "click", printGreeting, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Logo> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ printGreeting });
    	return [];
    }
    ...
    const file$1 = "src/components/NameTag.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span4 = element("span");
    			t8 = text(/*out3*/ ctx[2]);
    			attr_dev(span0, "class", "name firstlast svelte-1g1yawo");
    			add_location(span0, file$1, 25, 4, 510);
    			attr_dev(span1, "class", "bracket svelte-1g1yawo");
    			add_location(span1, file$1, 26, 4, 557);
    			attr_dev(span2, "class", "name middle svelte-1g1yawo");
    			add_location(span2, file$1, 27, 4, 592);
    			attr_dev(span3, "class", "bracket svelte-1g1yawo");
    			add_location(span3, file$1, 28, 4, 636);
    			attr_dev(span4, "class", "name firstlast svelte-1g1yawo");
    			add_location(span4, file$1, 29, 4, 671);
    			attr_dev(div, "class", "name-container svelte-1g1yawo");
    			add_location(div, file$1, 24, 0, 477);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class NameTag extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { first: 4, middle: 5, last: 6 });
    ...
    function create_fragment(ctx) {
    	...
    	background = new Background({
    			props: { numImages: /*numImages*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "text-body svelte-v684m5");
    			add_location(div, file, 11, 4, 326);
    			attr_dev(main, "class", "svelte-v684m5");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*numImages*/ 1) background_changes.numImages = /*numImages*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('numImages' in $$props) $$invalidate(0, numImages = $$props.numImages);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { numImages: 0 });
    		...
    		if (/*numImages*/ ctx[0] === undefined && !('numImages' in props)) {
    			console.warn("<App> was created without expected prop 'numImages'");
    		}
    	}
